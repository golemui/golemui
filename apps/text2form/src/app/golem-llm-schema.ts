...
const WIDGET = {
  ...
  properties: {
    ...
    type: {
      type: 'string',
      enum: [
        'textinput', 'password', 'textarea', 'number', 'currency',
        'checkbox', 'toggle', 'select', 'radiogroup', 'dropdown', 'list',
        'datePicker', 'calendar', 'rangeCalendar', 'dateInput', 'markdown',
        'button', 'alert', 'flex', 'accordion', 'tabs', 'repeater',
      ],
    },
    path: DOT_PATH,
    label: { type: 'string' },
