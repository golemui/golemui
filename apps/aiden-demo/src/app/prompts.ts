                    ...
                    template: {
                      ...
                      children: [
                        ...
                        },
                        {
                          ...
                          validator: { type: 'string', required: true },
                          include: { when: "$form.teams?.items?.members?.items?.memberType === 'Contractor'" },
                        },
                        {
                          kind: 'input',
                          type: 'number',
                        ...
                        },
                        {
                          ...
                          validator: { type: 'string', required: true },
                          include: { when: "$form.teams?.items?.members?.items?.memberType === 'External'" },
                        },
                        {
                          kind: 'input',
                          type: 'checkbox',
                        ...
                        },
                        {
                          ...
                          include: { when: "$form.teams?.items?.members?.items?.accessLevel === 'Admin'" },
                        },
                        {
                          kind: 'input',
                          type: 'dropdown',
                          ...
                          include: { when: '$form.teams?.items?.members?.items?.needsHardware === true' },
                        },
                        {
                          kind: 'input',
                          type: 'textarea',
