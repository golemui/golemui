  ...
  styles: [
    `
      ...
      .kx-card:hover {
        ...
        border-color: var(--kx-card-hover-border);
      }
      .kx-card::before {
        content: '';
        position: absolute;
  ...
  template: `
    <div class="kx-landing">
      <div class="kx-landing__inner">
        <span class="kx-landing__eyebrow">Analog Playground</span>
        ...
        <p class="kx-landing__subtitle">
          ...
          fits how you author forms. Every page is rendered on the server and hydrated in the
          browser.
        </p>

        <div class="kx-landing__grid">
          <a routerLink="/json/kitchen-sink" class="kx-card kx-card--json">
          ...
          <a routerLink="/dx/kitchen-sink" class="kx-card kx-card--dx">
            <div class="kx-card__head">
            ...
            <p class="kx-card__desc">
              ...
              <code>&lt;gui-form&gt;</code> runs <code>processDxFacade</code> internally, with
          ...
          <a routerLink="/dx/modular" class="kx-card kx-card--modular">
            <div class="kx-card__head">
            ...
            <p class="kx-card__desc">
              ...
              layout, data, and reactive states — merged at the boundary. This page is prerendered
              at build time.
            </p>
            <ul class="kx-card__list">
