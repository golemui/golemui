...
.kx-card__list li::before { content: ''; position: absolute; left: 0; top: 0.55rem; width: 6px; height: 6px; border-radius: 50%; background: var(--kx-card-accent); }
.kx-card__cta { margin-top: auto; display: inline-flex; align-items: center; gap: 0.4rem; font-weight: 600; color: var(--kx-card-accent); }
...
<div class="kx-landing">
  <div class="kx-landing__inner">
    <span class="kx-landing__eyebrow">Lit Playground</span>
    ...
    <div class="kx-landing__grid">
      <a href="#/json/kitchen-sink" class="kx-card kx-card--json">
      ...
      <a href="#/dx/kitchen-sink" class="kx-card kx-card--dx">
        <div class="kx-card__head">
