<template>
  <div class="kx-landing">
    <div class="kx-landing__inner">
      <span class="kx-landing__eyebrow">Nuxt Playground</span>
      ...
      <p class="kx-landing__subtitle">
        ...
        fits how you author forms. Every page is server rendered by Nuxt and hydrated on the client:
        view the page source to see the form markup arrive without JavaScript.
      </p>

      <div class="kx-landing__grid">
        <NuxtLink to="/json/kitchen-sink" class="kx-card kx-card--json">
        ...
        <NuxtLink to="/dx/kitchen-sink" class="kx-card kx-card--dx">
          <div class="kx-card__head">
        ...
        <NuxtLink to="/dx/modular" class="kx-card kx-card--modular">
          <div class="kx-card__head">
