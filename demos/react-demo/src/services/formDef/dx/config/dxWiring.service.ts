...
export class DxWiringService {
  ...
  wireSubmitButton(
    payload: SUBMIT_BUTTON_SHORTCUT | ActionDecorator | (() => ActionDecorator),
  ...
  wireButton(
    payload: ActionDecorator | (() => ActionDecorator),
    source: ParsedDxShortcut<ActionDecorator | (() => ActionDecorator)>,
  ): UnrolledControllers {
    return {
      type: 'controllers',
      source,
