...
| Custom widgets, custom item renderers, custom validators, custom middlewares, form plugins                                         | [references/extending.md](references/extending.md)                                              |
| Expose a form to the browser's AI agent (WebMCP, `@golemui/webmcp`)                                                               | [references/webmcp.md](references/webmcp.md)                                                    |
