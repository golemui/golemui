    ...
    switch (action.type) {
      ...
      case 'SET_DATA':
        return pipe(
          ...
          // reduceIf(isControlTouched, Reducers.validateAll(validatorConfig)),
        );
      ...
      case 'OVERRIDE_FIELD_PROP':
        return pipe(
          ...
          reduceIf(isControlTouched(action.payload.path), Reducers.validateAll(validatorConfig)),
        );
      ...
      case 'VALIDATE_ALL': {
        ...
        return pipe(newState, Reducers.validateAll(validatorConfig));
      }
      ...
      case 'ATTEMPT_VALIDATION': {
        ...
        if (shouldValidate) {
          return pipe(
            ...
            Reducers.validateAll(validatorConfig),
          );
        }
