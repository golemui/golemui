...
| **DxService special handling**  | `parseFieldKey` (path from key)                                                       | `extractOnClickFromMergeResult`, `wireOnClick` | `processLayoutItem` (recurse children)                                                                     | `processDisplayItem` (wrap as function widget) |
