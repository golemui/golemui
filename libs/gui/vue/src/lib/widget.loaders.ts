...
export const widgetLoaders: WidgetLoaders<Component<WithWidget>, GolemWidget> = {
  ...
  fileUpload: async () => (await import('./components/FileUpload.vue')).default,
  list: async () => (await import('./components/List.vue')).default,
  multiDropdown: async () => (await import('./components/MultiDropdown.vue')).default,
  multiFileUpload: async () => (await import('./components/MultiFileUpload.vue')).default,
  multiList: async () => (await import('./components/MultiList.vue')).default,
  ...
  rangeDateTimeInput: async () => (await import('./components/RangeDateTimeInput.vue')).default,
  rangeDateTimeCalendar: async () =>
    (await import('./components/RangeDateTimeCalendar.vue')).default,
  rangeDateTimePicker: async () => (await import('./components/RangeDateTimePicker.vue')).default,
