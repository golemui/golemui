...
import { TextareaProps } from '@golemui/gui-components';
...
export class TextareaElement extends LitElement implements Core.WithWidget {
  ...
  adapter = new Lit.InputWidgetAdapter<string, TextareaProps>();
