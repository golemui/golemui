...
// The factory binds the gui widget set (loaders, validators, value schemas,
// form input resolver) to the shared form element class. The subclass only
// chooses the tag name. Properties: config, autocomplete, formHealthBoundary.
// Methods: setData, setMeta.
