...
```bash
npm i @golemui/core @golemui/vue @golemui/gui-vue --save
```
...
| -------------- | ----------------- | ------------------------------------------------ |
| `@form-event`  | `Core.FormEvent`  | Fired when a widget fires a wired event.         |
| `@form-health` | `Core.FormHealth` | Fired when the form's validation status changes. |
