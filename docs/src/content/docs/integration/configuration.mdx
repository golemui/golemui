...
<DslTabs>
  <Fragment slot="dx">
    ...
    <IntegrationTabs>
      ...
      <Fragment slot="lit">
        ```ts
        html`<gui-form .config=${{ formDef, data: {} }}></gui-form>`;
        ```
      </Fragment>
    </IntegrationTabs>
...
<IntegrationTabs>
  <Fragment slot="react">
    ```tsx
    <GuiForm config={{ formDef, formSelectors, data: {} }} />
    ```
  </Fragment>
  <Fragment slot="angular">
    ```ts
  ...
  <Fragment slot="lit">
    ```ts
    html`<gui-form .config=${{ formDef, formSelectors, data: {} }}></gui-form>`;
    ```
  </Fragment>
</IntegrationTabs>
...
<IntegrationTabs>
  <Fragment slot="react">
    ```tsx
    <GuiForm config={{ formDef, formConfig, data: {} }} />
    ```
  </Fragment>
  <Fragment slot="angular">
    ```ts
  ...
  <Fragment slot="lit">
    ```ts
    html`<gui-form .config=${{ formDef, formConfig, data: {} }}></gui-form>`;
    ```
  </Fragment>
</IntegrationTabs>
...
<IntegrationTabs>
  <Fragment slot="react">
    ...
    <GuiForm config={{ formDef, data: formData }} />
    ```
  ...
  <Fragment slot="lit">
    ...
    // render():
    html`<gui-form .config=${{ formDef: this.formDef, data: this.data }}></gui-form>`;
    ```
...
<IntegrationTabs>
  <Fragment slot="react">
    ...
    <GuiForm config={{ formDef, data: formData, meta: formMeta }} />
    ```
  ...
  <Fragment slot="lit">
    ...
    // render():
    html`<gui-form
      .config=${{ formDef: this.formDef, data: {}, meta: this.meta }}
    ></gui-form>`;
    ```
  ...
  <Fragment slot="dx">
    ...
    <IntegrationTabs>
      <Fragment slot="react">
        ...
        // <GuiForm config={{ formDef, formConfig }} ... />
        ```
      </Fragment>
      <Fragment slot="angular">
        ```ts
  ...
  <Fragment slot="json">
    ...
    <IntegrationTabs>
      <Fragment slot="react">
        ...
        // <GuiForm config={{ formDef, customWidgetLoaders }} ... />
        ```
      </Fragment>
      <Fragment slot="angular">
        ```ts
  ...
  <Fragment slot="json">
    ...
    <IntegrationTabs>
      <Fragment slot="react">
        ...
        const itemRenderers = { countryRenderer: CountryRenderer };
        // <GuiForm config={{ formDef, itemRenderers }} ... />
        ```
      </Fragment>
      <Fragment slot="angular">
        ```ts
  ...
  <Fragment slot="json">
    ...
    <IntegrationTabs>
      <Fragment slot="react">
        ...
        const customValidators = { allowedNames };
        // <GuiForm config={{ formDef, customValidators }} ... />
        ```
      </Fragment>
      <Fragment slot="angular">
        ```ts
...
<DslTabs>
  ...
  <Fragment slot="json">
    ...
    <IntegrationTabs>
      <Fragment slot="react">
        ```tsx
        <GuiForm config={{ formDef, validateOn: 'change' }} />
        ```
      </Fragment>
      <Fragment slot="angular">
        ```html
        <gui-form [config]="{ formDef: formDef, validateOn: 'change' }"></gui-form>
        ```
      </Fragment>
      <Fragment slot="lit">
        ```ts
        html`<gui-form .config=${{ formDef: this.formDef, validateOn: 'change' }}></gui-form>`;
        ```
      </Fragment>
    </IntegrationTabs>
  ...
  <Fragment slot="json">
    ...
    <IntegrationTabs>
      <Fragment slot="react">
        ...
        // <GuiForm config={{ formDef, dependencies }} ... />
        ```
      </Fragment>
      <Fragment slot="angular">
        ```ts
...
<IntegrationTabs>
  ...
  <Fragment slot="lit">
    ...
    // render():
    html`<gui-form
      .config=${{ formDef: this.formDef, data: {}, middlewares: this.middlewares }}
    ></gui-form>`;
    ```
...
<IntegrationTabs>
  <Fragment slot="react">
    ```tsx
    <GuiForm config={{ formDef }} autocomplete="off" />
    ```
  </Fragment>
  <Fragment slot="angular">
    ```html
...
<IntegrationTabs>
  <Fragment slot="react">
    ```tsx
    <GuiForm config={{ formDef, formName: 'checkout' }} />
    ```
  </Fragment>
  <Fragment slot="angular">
    ```html
    <gui-form [config]="{ formDef: formDef, formName: 'checkout' }"></gui-form>
    ```
  </Fragment>
  <Fragment slot="lit">
    ```ts
    html`<gui-form .config=${{ formDef: this.formDef, formName: 'checkout' }}></gui-form>`;
    ```
  </Fragment>
</IntegrationTabs>
...
<IntegrationTabs>
  ...
  <Fragment slot="lit">
    ...
    // render():
    html`<gui-form
      .config=${{ formDef: this.formDef, data: this.formData }}
