...
<IntegrationTabs>
  <Fragment slot="react">
    ```tsx
    const config = { formDef, formSelectors, data: {} };
    // <GuiForm config={config} />
    ```
  </Fragment>
  <Fragment slot="angular">
    ...
    // template:
    // <gui-form [config]="config"></gui-form>
    protected config = { formDef, formSelectors, data: {} };
    ```
  </Fragment>
  <Fragment slot="lit">
    ```ts
    // class field:
    config = { formDef, formSelectors, data: {} };
    // render(): html`<gui-form .config=${this.config}></gui-form>`
    ```
  </Fragment>
  <Fragment slot="vue">
...
<IntegrationTabs>
  <Fragment slot="react">
    ```tsx
    const config = { formDef, formConfig, data: {} };
    // <GuiForm config={config} />
    ```
  </Fragment>
  <Fragment slot="angular">
    ...
    // template:
    // <gui-form [config]="config"></gui-form>
    protected config = { formDef, formConfig, data: {} };
    ```
  </Fragment>
  <Fragment slot="lit">
    ```ts
    // class field:
    config = { formDef, formConfig, data: {} };
    // render(): html`<gui-form .config=${this.config}></gui-form>`
    ```
  </Fragment>
  <Fragment slot="vue">
...
<IntegrationTabs>
  ...
  <Fragment slot="angular">
    ...
    // template:
    // <gui-form [config]="config"></gui-form>
    protected config = { formDef, data: {}, meta: { tenantId: 'acme-co', sessionId: 'abc-123' } };
    ```
  </Fragment>
  <Fragment slot="lit">
    ```ts
  ...
  <Fragment slot="json">
    ...
    <IntegrationTabs>
      ...
      <Fragment slot="angular">
        ...
        // template:
        // <gui-form [config]="config"></gui-form>
        protected config = { formDef, validateOn: 'change' as Core.ValidateOn };
        ```
      </Fragment>
      <Fragment slot="lit">
        ```ts
        // class field:
        config = { formDef: this.formDef, validateOn: 'change' as Core.ValidateOn };
        // render(): html`<gui-form .config=${this.config}></gui-form>`
        ```
      </Fragment>
      <Fragment slot="vue">
...
<IntegrationTabs>
  ...
  <Fragment slot="angular">
    ...
    // template:
    // <gui-form [config]="config"></gui-form>
    protected config = { formDef, data: {}, middlewares: [Core.devToolsMiddleware()] };
    ```
