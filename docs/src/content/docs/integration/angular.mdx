...
<DslTabs>
  <Fragment slot="dx">
    ...
    import { FormComponent, vanillaFieldLoaders } from '@golemui/gui-angular';
    ...
    export class MyFormComponent {
      ...
      protected vanillaFieldLoaders = { ...vanillaFieldLoaders };
    }
    ```
  </Fragment>
  <Fragment slot="json">
...
| `fieldLoaders`     | `FieldLoaders`           | Map of widget type loaders (e.g. vanilla components)  |
