...
import searchJson from '../../../../public/template/getting-started/rent-a-car/04-search.json?raw';
import searchDx from '../../../../public/template/getting-started-dx/rent-a-car/04-search.ts?raw';
export const configJson = '04-search.json';
export const configDx = '04-search.ts';
...
<Demo src="/template/index.html?form=template/getting-started/rent-a-car/04-search.json" minHeight="800" />
