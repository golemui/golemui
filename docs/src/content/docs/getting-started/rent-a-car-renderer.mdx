...
import rendererJson from '../../../../public/template/getting-started/rent-a-car/03-renderer.json?raw';
import rendererDx from '../../../../public/template/getting-started-dx/rent-a-car/03-renderer.ts?raw';
export const configJson = '03-renderer.json';
export const configDx = '03-renderer.ts';
...
<Demo src="/template/index.html?form=template/getting-started/rent-a-car/03-renderer.json" minHeight="800" />
