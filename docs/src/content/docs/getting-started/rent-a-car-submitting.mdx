...
<IntegrationTabs>
  ...
  <Fragment slot="vanilla">
    ...
    form.addEventListener('formSubmit', (e) => handleFormSubmit(e.detail));
    ```
...
- **[Form Definition API](/form-definition/overview/)** — the canonical JSON schema reference (and the matching `gui.*` programmatic shortcuts).
