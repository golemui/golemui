...
<Aside>
This import is entirely optional. If you skip it, you enter **headless mode** and widgets render without any visual styling. See [Going headless](#going-headless) below.
</Aside>
