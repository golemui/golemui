---
title: Overview
description: A layout widget that organizes and displays information
sidebar:
  order: 0
---

Layout Fields are widgets that organize and display information to users. An accordion, a stack, or tabs are examples of Layout Fields.
